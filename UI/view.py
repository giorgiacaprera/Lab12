...
class View:
    ...
    def load_interface(self):
        ...
        # TODO
        btn_cammino = ft.ElevatedButton('Cammino minimo', on_click=self.controller.handle_cammino_minimo)
        self.lista_visualizzazione_3 = ft.ListView(expand=True, spacing = 5)
